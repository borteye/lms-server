...
const CHECK_CLASS_NAME_EXIST_1 =
  "SELECT 1 FROM classes WHERE name ILIKE $1 AND class_level_id = $2 AND class_teacher = $3 AND department_id = $4 LIMIT 1";
const CHECK_CLASS_NAME_EXIST_2 =
  "SELECT 1 FROM classes WHERE name ILIKE $1 AND class_level_id = $2 AND department_id = $3 LIMIT 1";
